...
1. **Phase 2 Hyperparameter Optimization**: Comprehensive experiments testing attribution regularization, model capacity, and learning rates on the discovery dataset
...
**Dataset**: discovery cohort (preprocessed)
...
3. **Run explainability analysis**:
   ...
   python scripts/explain.py \
       ...
       --preprocessed-data preprocessed_discovery.pt \
